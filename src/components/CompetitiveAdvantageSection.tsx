...
export const CompetitiveAdvantageSection: React.FC = () => {
  const comparisonData = [
    ...
    { factor: 'Standardized Kurban Tracking', individual: 'Bervariasi', kn: '✓ Standar Terintegrasi Single App' },
    { factor: 'Digital Kurban Certificate', individual: 'Bervariasi', kn: '✓ Otomatis & Terverifikasi Digital' },
